...
#define PF_CR2 *(unsigned char*)0x501D /* FLASH */ 
...
#define FLASH_DUKR	*(unsigned char*)0x5064 /* External Interrupt Control */ 
#define EXTI_CR1 *(unsigned char*)0x50A0 
#define EXTI_CR2	*(unsigned char*)0x50A1 /* Reset Status */ 
//#define RST	*(unsigned char*) 0x50B3 /* CLOCK */ 
...
#define CLK_SWIMCCR	*(unsigned char*)0x50CD /* Watchdog Timer */ 
...
#define SPI_TXCRCR	*(unsigned char*)0x5207 /* I2C */ 
...
#define I2C_PECR	*(unsigned char*)0x521E /* ------------------- UART ------------------- */ 
...
#define UART1_PSCR	*(unsigned char*)0x523A /* UART_CR1 bits */ 
...
#define UART_CR1_PIEN (1 << 0) /* UART_CR2 bits */ 
...
#define UART_CR2_SBK (1 << 0) /* UART_CR3 bits */ 
...
#define UART_CR3_LBCL (1 << 0) /* UART_SR bits */ 
...
#define TIM1_OISR *(unsigned char*)0x526F /* TIM_IER bits */ 
...
#define TIM_IER_UIE (1 << 0) /* TIM_CR1 bits */ 
...
#define TIM_CR1_CEN (1 << 0) /* TIM_SR1 bits */ 
...
#define TIM2_CCR3L *(unsigned char*)0x5316 /* ------------------- TIMER4 ------------------- */ 
...
#define TIM4_ARR *(unsigned char*)0x5348 /* ADC1 */ 
