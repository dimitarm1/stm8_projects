...
#define LED7_1_GPIO_PORT  (GPIOD)
#define LED7_1_GPIO_PINS  (GPIO_PIN_2)
#define LED7_2_GPIO_PORT  (GPIOC)
#define LED7_2_GPIO_PINS  (GPIO_PIN_6)
#define LED7_3_GPIO_PORT  (GPIOD)
#define LED7_3_GPIO_PINS  (GPIO_PIN_3)
#define LED7_4_GPIO_PORT  (GPIOC)
#define LED7_4_GPIO_PINS  (GPIO_PIN_4)
#define LED7_5_GPIO_PORT  (GPIOC)
#define LED7_5_GPIO_PINS  (GPIO_PIN_7)
#define LED7_6_GPIO_PORT  (GPIOC)
#define LED7_6_GPIO_PINS  (GPIO_PIN_3)
